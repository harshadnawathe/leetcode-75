...
tests = [
    (
        ...
        {
            "args": {
                "head": ListNode.from_values([1, 3, 4, 7, 1, 2, 6]),
            },
            "expected": ListNode.from_values([1, 3, 4, 1, 2, 6]),
        },
    ),
    (
        "Example 2",
        {
            "args": {
                "head": ListNode.from_values([1, 2, 3, 4]),
            },
            "expected": ListNode.from_values([1, 2, 4]),
        },
    ),
    (
        "Example 3",
        {
            "args": {
                "head": ListNode.from_values([2, 1]),
            },
            "expected": ListNode.from_values([2]),
        },
    ),
]
